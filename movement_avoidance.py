...
def resultant_angle(attract_angle, repulse_angle, repulse_magnitude, max_repulse_magnitude=1.0):
...
repulse_ang, repulse_mag = repulse_angle(agent_test_qpos, food_test_pos, 2.828427)
...
print(attract_ang_d)
print("@@@@@@@@@@@@@@@@@@@@@@")
resultant_ang2 = resultant_angle(attract_ang, repulse_ang, repulse_mag)
print(resultant_ang2)
resultant_ang2_d = resultant_ang2 * 180 / np.pi
print(resultant_ang2_d)
